        ...
        <div>
            ...
            <div className="max-w-[1280px] h-[calc(100dvh_-_80px)] m-[0_auto] flex justify-center items-center">
                <div className="flex flex-col gap-[48px]">
                    <span className="font-p-semibold text-[24px] text-stone-900 text-center">
                        덕질 플랜에 가입하면
                        <br />더 빠르게 소식을 접할 수 있어요.
                    </span>

                    <div className="flex gap-[24px]">
                        <div className="w-[300px] h-[360px] p-[24px] border border-stone-200 rounded-[12px] flex flex-col justify-between">
                        ...
                        <div className="w-[300px] h-[360px] p-[24px] border border-stone-900 rounded-[12px] flex flex-col justify-between">
                            <div className="flex flex-col gap-[24px]">
                                <span className="font-p-semibold text-[18px] text-stone-900">
                                    덕질
                                </span>
